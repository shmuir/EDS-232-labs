...
- The fourth model with with all three key predictors has the highest accuracy.
...
- The confusion matrix is telling us that the model is ~90% accurate. This is calculated by summing the number of correctly classified and dividing by the total number of predictions.
...
This final model is pretty similar in accuracy to the cross validation accuracy. I think this was expected since we had a relatively high accuracy and all of the vairbles we used for prediction seem to be significant contributors. 
