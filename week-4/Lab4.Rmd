...
- The confusion matrix is telling us that the model is ~90% accurate. This is calculated by summing the number of correctly classified and dividing by the total number of values.
