...
**The plot looks like a hierarchical structure and there seems to be 3 groups if the branches are cut at a cluster distance of around 75. Though there are potentially outliers on the far left (51-18). These points take the longest to become nested with the rest of the dendrogram. If these are cut from the rest of the dendrogram, we would have two clusters.** 
