...
- There are other variables that have a stronger correlation with price than package type, such as variety. The relationship may also not be best represented by a linear model. Package type is also a catagorical variable, so we do not get much spread in the data. 
